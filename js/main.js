(() => {
  ...
  const translations = {
    zh: {
      ...
      researchTitle:"研究成果",paperCandidate:"最佳論文候選",paperSummary:"以相機幾何與可解釋模組結合深度學習，進行單目 3D 車輛偵測；於 CARLA 場景評估。",paperVenue:"CVGIP 2026 研討會",
    ...
    en: {
      ...
      researchTitle:"Research",paperCandidate:"Best Paper Candidate",paperSummary:"An interpretable monocular 3D vehicle detection method combining deep-learning perception with camera geometry, evaluated in CARLA.",paperVenue:"CVGIP 2026 conference",
