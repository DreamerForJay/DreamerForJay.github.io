(() => {
  ...
  const translations = {
    zh: {
      ...
      researchTitle:"研究成果",paperCandidate:"最佳論文候選",paperTitle:"GEMO3D：結合深度學習感知、相機幾何與投影高度比例補償之單目 3D 車輛偵測方法",paperSummary:"將深度學習感知、相機幾何與投影高度比例補償整合成可解釋的單目 3D 車輛偵測流程，並於 CARLA 場景評估。",paperVenue:"CVGIP 2026 研討會",
