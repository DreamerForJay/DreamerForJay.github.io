(() => {
  ...
  const translations = {
    zh: {
      ...
      workTitle:"AWS 黑客松專案",workIntro:"kinsun.ai — 智慧長照 AI 陪伴系統",kinsunDesc:"智慧長照 AI 陪伴系統：以在地語言、記憶確認、安全評估與協作開發，打造更有溫度的日常陪伴。",detoxTitle:"數位防腐劑",
      ...
      project3:"以 PLC、液位感測器與警示元件打造水位變化預先警報系統，獲世界青少年發明展臺灣選拔銅牌。",kinsunRole:"產品設計、AI 安全與協作開發",kinsunContext:"AWS 黑客松參賽專案",merlanceRole:"產品敘事、體驗流程與技術研究",merlanceOutcome:"2025 康寧創星家優等獎",detoxRole:"組長、方法設計與使用者體驗",detoxOutcome:"AI Junior Award 2025 參賽成果",ieyiBuild:"PLC 水位偵測與多狀態警報系統",ieyiOutcome:"臺灣選拔銅牌",
    ...
    en: {
      ...
      workTitle:"AWS Hackathon Project",workIntro:"kinsun.ai — an AI companion for long-term care",kinsunDesc:"An AI companion for long-term care, combining local-language interaction, memory confirmation, safety evaluation, and collaborative development.",detoxTitle:"Digital Preservative",
